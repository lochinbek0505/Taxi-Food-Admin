...
class ExsistCateogry extends StatefulWidget {
  final String foodTypeId;
  final String restoruanId;

  ExsistCateogry({required this.restoruanId, required this.foodTypeId});

  @override
  _FoodPageState createState() => _FoodPageState();
}

class _FoodPageState extends State<ExsistCateogry> {
  bool isVeg = false;
